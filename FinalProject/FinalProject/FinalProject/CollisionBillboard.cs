...
namespace FinalProject
{
    class CollisionBillboard
    {
        ...
        private void buildBoundingSphere()
        {
            ...
            BoundingSphere sphere = new BoundingSphere(pos, 10);
